...
const duckNames = [
  ...
  "Rietradar - Rachel",
  "Ray Relschopper",
  "Reddingsboei Richard",
  "Sloopduck - Stephan",
  "Tosti Te Water Tim",
  "Vinylvleugel Veronica",
  "Strandwacht - Steffie",
  "Kelly Kwekservice",
  ...
  "Duikplank - Denise",
  "Bilnaad Barry",
  "Wipkip Willy Worstenbrood",
  "Schuine Snavel - Sjef",
  "Plonsbroek Pietje",
  "Reddingsvest Romance Ria",
  "Te Waterbed - Tonnie",
  "Klapstoel Casanova Kees",
  "Aquaplaning Afterparty Annie",
  "Handdoekje-Leggen Harrie",
  "Mee Naar Boven - Miep",
  "Luchtbedliefde Lowie",
  "Frietvet Flirt - Frits",
  "Terras-Tinder Truus",
  "Buitendouche Bennie",
  "Strandtas-Sjans - Sjaan",
  "Grote Bek Gerrie",
  "Limonade-Lik Liesje",
  "Koelbox-Knipoog Koos",
  "Riet-Romeo - Rinus",
  "Tenenbad Tease Toos",
  "Afzetlint Afterdark - Adje",
  "Mini-Pool Maxi-Sjans Marietje",
  "Jetlag Jatter Joost",
  "Nat Pak - Nellie",
  "Drijfsandaal Deluxe Dirk",
  "Poolnoodle Pretpaal - Puck",
  "Snackbar-Scharrel Sjors",
  "Mopperduck Met Moves Mats",
  "Lawaai Lingerie - Lola",
  "Reddingsring-Romance Raffie",
  "Beachbal Booty Bibi",
  "Gieter-Gigolo - Gijs",
  "Natte Krant Noor",
  "Flipflop-Flirt Fenna",
  ...
  "Muntblaadje Mojito Mila",
  "Schuimkop-Sjans Saar",
  "Nekkletser - Noud",
  "Floatie-Flirt Fleur",
  "Luchtmatras-Legende Lex",
  "Mojito-Magneet - Morris",
  "Plonsalarm Pillowtalk Pip",
  "Kabaal Kamasutra Kiki",
  "Tuinslang Tango - Teun",
  "Limoncello-Liefde Lotte",
  "Baddabber-Bilspier Boris",
  "Jacuzzi-Jatter - Jip",
  "Natnek Nachtduik Nina",
  "Snavelbek Scharrel Sam",
  "Eendje-Erbij - Eva",
  "Mosquito-Masseur Moos",
  "IJsblok-IJsbreker Isa",
  "Rietduiker-Romantiek - Ravi",
  "Noodlanding Naaktstrand Nora",
  "Golfslag-Glimlach Guus",
  "Matroos Met Matras - Mick",
  "Luchtbedlek-Liefje Lieke",
  "Tropenduck Tongen Tijn",
  "Frietkraam-Flirt - Floor",
  "Opblaasboot-Ontsnapt Olivier",
  "Sproeikop-Sjans Sofie",
  "Cabana-Crash Cas",
  "Vijvervandaal Verleidelijk - Vera"
];
